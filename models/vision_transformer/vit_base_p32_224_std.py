...
data_cfg = dict(
    ...
    train = dict(
        ...
        pretrained_weights = '/home/jiyarong/MS-FGNET-kidney/pretrain/vit_b_32-d86f8d99.pth',
        freeze_flag = False,
        freeze_layers = ('backbone',),
        epoches = 100,
    ),
    test=dict(
        ckpt = '/home/jiyarong/MassSpectrumCls_jia_5_mp_2fold/logs/VisionTransformer/2025-07-03-17-11-27/Val_Epoch077-Acc62.500.pth',
