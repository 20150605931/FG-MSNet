...
class WeightedPartClsHead_SP(ClsHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(WeightedPartClsHead_SP, self).__init__(init_cfg=init_cfg, *args, **kwargs)
    ...
    def get_logits(self, feature_list):
        avg_logits = 0
        logits_list = []
        global_logits = self.fc(feature_list[0])  #把全局池化得到的向量送入fc层
