...
class WeightedPartClsHead_recurrent_1(ClsHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(WeightedPartClsHead_recurrent_1, self).__init__(init_cfg=init_cfg, *args, **kwargs)
    ...
    def loss(self, score_list, gt_label, **kwargs):
            ...
            #     # compute accuracy
            #     with torch.no_grad():
            #         global_acc = self.compute_accuracy(part_logits_list, gt_label)
    ...
    def get_logits(self, feature_list):
        ...
        #ini_logits = self.fc(feature_list[0].squeeze(3).squeeze(2))
        ...
        #recurrent_logits = self.fc(feature_list[3].squeeze(3).squeeze(2))
